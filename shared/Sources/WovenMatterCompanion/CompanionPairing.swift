...
public struct CompanionPairingPayload: Codable, Equatable, Sendable {
  ...
  public init(endpoint: URL, token: String, protocolVersion: Int = 1) throws {
...
public struct CompanionPairRequest: Codable, Equatable, Sendable {
  ...
  public let protocolVersion: Int
  public init(token: String, deviceID: String, deviceName: String, protocolVersion: Int = 1) {
...
public struct CompanionPairResponse: Codable, Equatable, Sendable {
  ...
  public let protocolVersion: Int
  public init(workspaceID: String, deviceID: String, credential: String, protocolVersion: Int = 1) {
...
public struct CompanionHello: Codable, Equatable, Sendable {
  ...
  public init(workspaceID: String, protocolVersion: Int = 1, hostName: String, capabilities: [String]) {
