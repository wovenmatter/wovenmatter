...
- Local Agent Workspace lists OpenCode with the other runtimes: **More**, **Show/Hide**, and **Download** when missing or **Enable/Disable** when installed. More opens the dedicated OpenCode settings page, immediately below OpenClaw in Settings.
